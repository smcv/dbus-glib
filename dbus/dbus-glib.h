...
G_DEPRECATED_FOR(g_dbus_connection_flush or dbus_connection_flush)
void              dbus_g_connection_flush        (DBusGConnection        *connection);

G_DEPRECATED_FOR(G_DBUS_ERROR or DBusError)
GQuark dbus_g_error_quark (void);
#define DBUS_GERROR dbus_g_error_quark ()

typedef enum G_GNUC_DEPRECATED_FOR(GDBusError)
{
DBUS_GERROR_FAILED,
...
G_DEPRECATED_FOR(g_dbus_error_is_remote_error)
gboolean         dbus_g_error_has_name    (GError      *error,
					   const char  *name);
G_DEPRECATED_FOR(g_dbus_error_get_remote_error)
const char *     dbus_g_error_get_name    (GError      *error);

G_DEPRECATED_FOR(libdbus >= 1.6)
void             dbus_g_thread_init (void);

G_DEPRECATED_FOR(g_dbus_connection_new_for_address or dbus_connection_open)
DBusGConnection* dbus_g_connection_open (const gchar  *address,
                                         GError      **error);
G_DEPRECATED_FOR(g_dbus_connection_new_for_address or dbus_connection_open_private)
DBusGConnection* dbus_g_connection_open_private (const gchar  *address,
                                                 GMainContext *context,
                                                 GError      **error);
G_DEPRECATED_FOR(g_bus_get or dbus_bus_get)
DBusGConnection* dbus_g_bus_get         (DBusBusType   type,
                                         GError      **error);
G_DEPRECATED_FOR(g_dbus_connection_new_for_address or dbus_bus_get_private)
 ...
 */
struct G_GNUC_DEPRECATED_FOR(GDBusMethodInfo) _DBusGMethodInfo
{
  GCallback                 function;    
 ...
 */
struct G_GNUC_DEPRECATED_FOR(GDBusInterfaceVTable or GDBusInterfaceSkeleton) _DBusGObjectInfo
{
  int   format_version;
...
G_DEPRECATED_FOR(g_dbus_error_register_error_domain)
void       dbus_g_error_domain_register        (GQuark                domain,
						const char *          default_iface,
						GType                 code_enum);

G_DEPRECATED_FOR(g_dbus_connection_register_object)
void       dbus_g_connection_register_g_object (DBusGConnection       *connection,
						const char            *at_path,
						GObject               *object);
G_DEPRECATED_FOR(g_dbus_connection_unregister_object)
...
G_DEPRECATED_FOR(GDBus or libdbus)
...
typedef struct _DBusGProxy       DBusGProxy G_GNUC_DEPRECATED_FOR(GDBusProxy);
typedef struct _DBusGProxyClass  DBusGProxyClass G_GNUC_DEPRECATED_FOR(GDBusProxy);
...
typedef struct _DBusGProxyCall DBusGProxyCall G_GNUC_DEPRECATED_FOR(GAsyncResult);
typedef void (* DBusGProxyCallNotify) (DBusGProxy       *proxy,
				       DBusGProxyCall   *call_id,
				       void             *user_data)
  G_GNUC_DEPRECATED_FOR(GAsyncReadyCallback);

G_DEPRECATED_FOR(GDBusProxy)
GType             dbus_g_proxy_get_type              (void) G_GNUC_CONST;
G_DEPRECATED_FOR(g_dbus_proxy_new)
...
G_DEPRECATED_FOR(GDBusProxy::g-signal or gdbus-codegen)
void              dbus_g_proxy_add_signal            (DBusGProxy        *proxy,
						      const char        *signal_name,
						      GType              first_type, 
						      ...);

G_DEPRECATED_FOR(GDBusProxy::g-signal)
...
G_DEPRECATED_FOR(g_dbus_proxy_call)
...
G_DEPRECATED_FOR(GAsyncResult)
gboolean          dbus_g_proxy_end_call              (DBusGProxy        *proxy,
                                                      DBusGProxyCall    *call,
                                                      GError           **error,
                                                      GType              first_arg_type,
                                                      ...);
G_DEPRECATED_FOR(GCancellable)
...
typedef struct G_GNUC_DEPRECATED {
  GCallback cb;
  gpointer userdata;
} DBusGAsyncData;
